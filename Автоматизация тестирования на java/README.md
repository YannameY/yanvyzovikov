# :mag_right: Инженер по автоматизированному тестированию — Яндекс.Практикум / Automation QA Engineer — Yandex.Praktikum
...
|----|--------|------------------|-------------------------|
| 1  | [UI-тестирование](link-to-ui-tests) | Автоматизация тестирования веб-интерфейсов с использованием Selenium WebDriver | Java, Selenium, JUnit, Allure |
| 2  | [Юнит-тесты](link-to-unit-tests) | Написание модульных тестов для проверки отдельных компонентов системы | Java, JUnit, Mockito |
| 3  | [API-тесты](link-to-api-tests) | Автоматизация тестирования REST API | Java, RestAssured, JUnit, Allure |
